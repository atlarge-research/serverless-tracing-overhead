    ...
    for filename in os.listdir(directory):
        if "aggregated_statistics" in filename and filename.endswith(".csv"):
            ...
            table_data.append({
                ...
                'Avg. Time (ms)': total_avg_time,
                'Median (ms)': total_median_time,
                'Configuration (%)': avg_percent_time['Configuration'],
                'Instrumentation (%)': avg_percent_time['Instrumentation'],
                'Export (%)': avg_percent_time['Export'],
                'Task (%)': avg_percent_time['Task'],
            })
