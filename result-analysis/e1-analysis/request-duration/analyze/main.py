...
def analyze(k6_path, cpu_file_path, plots_dir, metrics_dir):
    ...
    languages = ['python', 'java', 'go', 'nodejs']
    ...
    for lang in languages:
        k6_stats.plot_cpu_usage_by_scenarios(scenarios, lang, 'json', 'otel',
                                             plot_name=f'cpu-usage-scenarios-{lang}-json')
        k6_stats.plot_cpu_usage_by_scenarios(scenarios, lang, 'db', 'otel',
                                             plot_name=f'cpu-usage-scenarios-{lang}-db')
        k6_stats.plot_cpu_usage_by_scenarios(scenarios, lang, 'updates', 'otel',
                                             plot_name=f'cpu-usage-scenarios-{lang}-updates')
        k6_stats.plot_cpu_usage_by_scenarios(scenarios, lang, 'queries', 'otel',
...
if __name__ == '__main__':
    ...
    # TODO: Take one example and sketch plots (show that the CPU is stable)
    ## TODO: Node.js example?
    k6_path_2 = '../results/cpu/2024-10-20_08-37.csv'
    # k6_path_2 = '../results/2024-05-22/2024-05-22_19-33-test.csv'
    cpu_file_path_2 = "../results/cpu/cpu_usage_2024-10-20_08-37.csv"
    plots_dir_2 = "plots/2024-10-20"
    metrics_dir_2 = "metrics/2024-10-20"
