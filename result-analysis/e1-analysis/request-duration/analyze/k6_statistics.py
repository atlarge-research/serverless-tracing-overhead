...
class K6Statistics:
    ...
    def plot_cpu_usage_by_scenarios(self, scenarios, language, endpoint, configuration=None, plot_name=None, save_plot=True):
        """
        ...
        if configuration is not None:
            relevant_scenarios = [s for s in relevant_scenarios if configuration in s['scenario_name']]
